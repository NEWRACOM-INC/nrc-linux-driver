...
struct nrc {
	...
	u8 dtim_period;
	struct timer_list tim_send_timer;
};
...
struct ps_status {
	struct timer_list soft_ps_timer;
...
extern bool discard_ipv6_mc_frame;
extern bool discard_ipv4_mc_frame;
