...
enum nrc_vendor_event {
	...
	NRC_SUBCMD_ANNOUNCE7,
	NRC_SUBCMD_BCAST_FOTA_INFO,
	NRC_SUBCMD_BCAST_FOTA_1,
	NRC_SUBCMD_BCAST_FOTA_2,
	NRC_SUBCMD_BCAST_FOTA_3,
	NRC_SUBCMD_BCAST_FOTA_4,
	NRC_SUBCMD_ANNOUNCE8,	// vendor ie in probe request (1).  // 12
	NRC_SUBCMD_ANNOUNCE9,	// vendor ie in probe request (2).
	NRC_SUBCMD_ANNOUNCE10,	// vendor ie in probe request (3).
	NRC_SUBCMD_ANNOUNCE11,	// vendor ie in probe request (4).
	NRC_SUBCMD_ANNOUNCE12,	// vendor ie in probe request (5).  // 16
	NRC_SUBCMD_ANNOUNCE13,	// vendor ie in probe response (1). // 17
	NRC_SUBCMD_ANNOUNCE14,	// vendor ie in probe response (2).
	NRC_SUBCMD_ANNOUNCE15,	// vendor ie in probe response (3).
	NRC_SUBCMD_ANNOUNCE16,	// vendor ie in probe response (4).
	NRC_SUBCMD_ANNOUNCE17,	// vendor ie in probe response (5). // 21
	NRC_SUBCMD_ANNOUNCE18,	// vendor ie in assoc request (1).  // 22
	NRC_SUBCMD_ANNOUNCE19,	// vendor ie in assoc request (2).
	NRC_SUBCMD_ANNOUNCE20,	// vendor ie in assoc request (3).
	NRC_SUBCMD_ANNOUNCE21,	// vendor ie in assoc request (4).
	NRC_SUBCMD_ANNOUNCE22,	// vendor ie in assoc request (5).  // 26
	NRC_SUBCMD_UTC, // 27 (0x1B)
	NRC_SUBCMD_SOLUM_HMG0, // 28 (0x1C)
	NRC_SUBCMD_SOLUM_HMG1,
	NRC_SUBCMD_SOLUM_HMG2,
	NRC_SUBCMD_RTCM0, // 31 (0x1F)
	NRC_SUBCMD_RTCM1,
	NRC_SUBCMD_RTCM2,
	NRC_SUBCMD_RTCM3,
	NRC_SUBCMD_RTCM4,
	NRC_SUBCMD_RTCM5,
	NRC_SUBCMD_RTCM6,
	NRC_SUBCMD_REMOTECMD, // 38 (0x26)
	NRC_SUBCMD_WOWLAN_PATTERN, // 39 (0x27)
	NUM_VENDOR_EVENT,
